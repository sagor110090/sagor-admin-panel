<aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
        ...
        @if (Auth::user()->role == 'Super Admin')
            ...
            {{-- <li
                class="dropdown {{ Request::is('admin/activities*') ? 'active' : '' }}">
        ...
        {{-- <li class="sidebar-item"> <a
                ...
                aria-expanded="false"><i class="mdi mdi-television-guide"></i><span class="hide-menu">Test</span></a>
        ...
        @if (Helper::authCheck('test1-show') || Helper::authCheck('test1-create'))
            <li class="dropdown {{ Request::is('admin/test1*') ? 'active' : '' }}"> <a href="#"
                    class="menu-toggle nav-link has-dropdown"><i data-feather="copy"></i><span>Test1 </span></a>
                <ul class="dropdown-menu">
                    @if (Helper::authCheck('test1-create'))
                        <li class="{{ Request::is('admin/test1/create*') ? 'active' : '' }}"><a class="nav-link"
                                href="{{ url('admin/test1/create') }}">New Test1</a></li>
                    @endif
                    @if (Helper::authCheck('test1-show'))
                        <li class="{{ Request::is('admin/test1') ? 'active' : '' }}"><a class="nav-link"
                                href="{{ url('admin/test1') }}">Test1 List</a></li>
                    @endif
                </ul>
            </li>
        @endif 
