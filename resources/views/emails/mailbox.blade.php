                    ...
                    <div class="body">
                        <div id="mail-nav">
                            ...
                            <ul class="" id="mail-folders">
                                <li>
                                    <a href="javascript:;" title="Sent">Sent
                                        ({{Helper::getAll('mailboxs')->where('status','send')->count()}})</a>
                                </li>
                                <li>
                        ...
                        <div class="boxs mail_listing">
                            <div class="inbox-center table-responsive">
                                <table class="table table-hover" >
                                                ...
                                                <div class="inbox-header">
                                                    <div class="mail-option">
                                                        <div class="email-btn-group m-l-15">
                                                            ...
                                                            <form action="{{ url('admin/emails/delete') }}" id="deleteButton1" method="get">

                                                            <a href="" id="delete-btn" class="col-dark-gray waves-effect m-r-20"
                                    ...
                                    <tbody>
                                        @foreach (Helper::getAll('mailboxs') as $item)

                                        <tr class="unread">
                                            <td class="tbl-checkbox">
                                                <label class="form-check-label">
                                                    <input type="checkbox" class="checkbox-chack" name="select_email[]" value="{{$item->id}}">
                                                    <span class="form-check-sign"></span>
                                                </label>
                                            </td>
                                            <td class="hidden-xs"><a
                                                    href="{{ asset('/admin/email/'.$item->id) }}">{{$item->subject}}</a>
                                            </td>
                                            {{-- <td class="max-texts">
